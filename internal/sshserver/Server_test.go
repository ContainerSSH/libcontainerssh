...
func (f *fullNetworkConnectionHandler) OnAuthPubKey(username string, pubKey string, _ string, _ *sshserver.CACertificate) (response sshserver.AuthResponse, metadata map[string]string, reason error) {

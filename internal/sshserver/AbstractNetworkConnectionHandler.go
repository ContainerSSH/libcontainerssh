...
func (a *AbstractNetworkConnectionHandler) OnAuthPubKey(_ string, _ string, _ string, _ *CACertificate) (response AuthResponse, metadata map[string]string, reason error) {
	return AuthResponseUnavailable, nil, nil
}
